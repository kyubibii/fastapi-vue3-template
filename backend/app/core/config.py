...
class Settings(BaseSettings):
    ...
    SETTINGS_BOOTSTRAP_ITEMS: list[dict[str, Any]] = [
        ...
        # ── WeChat Pay ─────────────────────────────────────────────────────
        {
            "setting_name": "wechat_pay_app_id",
            "setting_value": "",
            "setting_group": "wechat_pay",
            "value_type": "string",
            "description": "小程序/公众号 AppID",
        },
        {
            "setting_name": "wechat_pay_mch_id",
            "setting_value": "",
            "setting_group": "wechat_pay",
            "value_type": "string",
            "description": "微信支付商户号",
        ...
        {
            "setting_name": "wechat_pay_api_v3_key",
            "setting_value": "",
            "setting_group": "wechat_pay",
            "value_type": "string",
            "description": "微信支付 API v3 密钥（32字节）",
            "is_sensitive": True,
            "is_encrypted": True,
        },
        {
            "setting_name": "wechat_pay_cert_serial",
            "setting_value": "",
            "setting_group": "wechat_pay",
            "value_type": "string",
        ...
        {
            "setting_name": "wechat_pay_private_key",
            "setting_value": "",
            "setting_group": "wechat_pay",
            "value_type": "string",
            "description": "商户 API 证书私钥（PEM 格式）",
            "is_sensitive": True,
            "is_encrypted": True,
        },
        {
            "setting_name": "wechat_pay_public_key_id",
            "setting_value": "",
            "setting_group": "wechat_pay",
            "value_type": "string",
            "description": "微信支付公钥 ID",
        },
        {
            "setting_name": "wechat_pay_public_key",
            "setting_value": "",
            "setting_group": "wechat_pay",
            "value_type": "string",
            "description": "微信支付公钥（PEM 格式）",
            "is_sensitive": True,
            "is_encrypted": True,
        },
        {
            "setting_name": "wechat_pay_notify_base_url",
            "setting_value": "",
            "setting_group": "wechat_pay",
            "value_type": "string",
            "description": "支付回调通知基础 URL（如 https://yourdomain.com）",
        },
    ]
